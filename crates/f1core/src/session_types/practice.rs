...
pub async fn bootstrap(
    ...
    // 1. Drivers — skip if already cached
    ...
    // 2. Fetch practice-relevant endpoints: laps, stints, weather.
    // No intervals/positions/pit_stops needed for practice analysis.
    let endpoints = [Endpoint::Laps, Endpoint::Stints, Endpoint::Weather];
